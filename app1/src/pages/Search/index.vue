  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector @attrInfo="attrInfo" @SendTrademark="SendTrademark" />
            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{ active: isOne }">
                  <!-- {active:true} -->
                  <!-- active -->
                  <a @click="compositeOrder">综合<span ref="arrow">⬇</span></a>
                </li>
                <li>
                  <a href="#">销量</a>
                </li>
                ...
                <li :class="{ active: isTwoAndAsc }">
                  <a @click="priceAsc">价格⬆</a>
                </li>
                <li :class="{ active: isTwoAndDesc }">
                  <a @click="priceDesc">价格⬇</a>
                </li>
              </ul>
            </div>
          </div>
